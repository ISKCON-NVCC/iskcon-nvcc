      ...
      <main className="px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-[#F2E6D8] p-6">
            ...
            <button className="w-full bg-[#F58220] text-white py-3 px-4 rounded-lg mb-3 flex items-center justify-start gap-2">
              <IoMdAddCircleOutline />
              Create New Form
            </button>

            <button className="w-full border border-[#F2E6D8] py-3 px-4 rounded-lg text-[#4A2E1F] flex items-center justify-start gap-2 hover:bg-[#FFF1E3] hover:text-[#F58220] transition-colors duration-200">
              <SiGoogleforms />
              View All Forms
            </button>
          </div>
